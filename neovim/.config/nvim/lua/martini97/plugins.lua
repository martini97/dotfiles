...
return require("packer").startup(function(use)
  ...
  use {
    ...
    config = function ()
      require('martini97.telescope').setup()
    end,
  }
  ...
  use {
    ...
    config = function()
      require("martini97.treesitter").setup()
    end,
  }
  ...
  use {
    ...
    config = function()
      require('martini97.statusline').setup()
    end,
